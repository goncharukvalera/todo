...
// Можно использовать в деструктивных выражениях значение по умолчанию
/*
[a, b, c = 1000] = [11,22];
console.log(a, b, c);
*/

// Деструктурирование вложенного массива (nested array)
/*
...
foo("This", 'is', "destructuring");
*/


/*
function log(msg, {car: carName, model: carModel}) {
    console.log(`${msg} ${carName} ${carModel} is great car`);
}

log('Car' {car: 'Audi', model: 'A8' });
*/
...
function courseDetails(obj){
    let {carName, carModel, price = 44000} = obj;
    console.log(`Car ${carName} ${carModel} with price - ${price}`
    );
}
...
// Rest properties с destruct - собирают оставшиеся от destruct свойства объекта в новый объект
...
// Spread properties в объекте инициализирут копирование свойств из объекта в новый объект.
...
// при этом одноименные свойства перезаписываются по правилу приоритета у правого одноименного свойства
let o3 = {
    age: 33
};
